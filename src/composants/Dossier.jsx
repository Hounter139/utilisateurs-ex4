...
import defautimage from "../images/couverture.webp";
  ...
  return (
    <article className="Dossier" style={{backgroundColor: couleur}}>
      <div className="couverture">
        ...
        <img src={(couverture?couverture:defautimage)} alt={nom}/>
      </div>
      <div className="info">
        <h2>{nom}</h2>
        <p>Modifié : {formaterDate(datemodif)}</p>
      </div>
      <IconButton className="modifier" onClick={ouvrirmenu} aria-label="modifier" size="small">
        <MoreVertIcon />
      </IconButton>
      <Menu
        id="simple-menu"
